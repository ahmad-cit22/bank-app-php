                  ...
                  <?php foreach ($allUsers as $user) : ?>
                    <li class="relative flex justify-between px-4 py-5 gap-x-6 hover:bg-gray-50 sm:px-6 lg:px-8">
                      <div class="flex gap-x-4">
                        ...
                        <!-- Profile Picture made with name initial -->
                        <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-sky-500">
                          <span class="text-xl font-medium leading-none text-white"><?= Utility::generateNameInitials($user['name']) ?></span>
                        </span>
                        ...
                        <div class="flex-auto min-w-0">
                          ...
                          <p class="flex mt-1 text-xs leading-5 text-gray-500">
                            <a href="./customer_transactions.php?id=<?= $user['id'] ?>" class="relative truncate hover:underline"><?= $user['email'] ?></a>
                          </p>
                        </div>
                      </div>
                    </li>
